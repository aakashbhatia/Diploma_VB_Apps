...
Begin VB.Form Calc_Form 
   ...
   Caption         =   "Calculator Designed & Developed By Aakash Bhatia"
   ClientHeight    =   6150
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6990
...
MsgBox "Please Enter number First in text2"
ElseIf Text1.Text = "" Then
MsgBox "Please Enter number First in text1"
...
If Text2.Visible = True Then
  ...
  If Text2.Text = "" Then
    ...
    Text2.SetFocus
  Else
    binary = CInt(Text2.Text)
    If binary = 0 Then

    Else
     Text2.Text = ""
     While binary > 0
      binary1 = (binary / 2) - 0.25
      Text2.Text = CStr(a Mod 2) + Text1.Text
      binary = binary1
     Wend
    End If
    Cmdbinary.Enabled = False
    End If
Else
  ...
  Else
   binary = CInt(Text1.Text)
    ...
    Else
     ...
     While binary > 0
      binary1 = (binary / 2) - 0.25
      Text1.Text = CStr(binary Mod 2) & Text1.Text
      binary = binary1
     Wend
    End If
    Cmdbinary.Enabled = False
